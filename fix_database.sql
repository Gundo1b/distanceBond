...
-- 4. Truth or Dare shared couple game
...
-- 5. Truth or Dare responses and media uploads
...
DO $$
BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.truth_or_dare_messages;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
